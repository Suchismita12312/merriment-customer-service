...
public class CustomerApiController {
    ...
    public ResponseEntity<ResponseMetaData> registerCustomer(@PathVariable String type, @RequestBody RegisterCustomerRequest registerCustomerRequest) throws RestClientException {
